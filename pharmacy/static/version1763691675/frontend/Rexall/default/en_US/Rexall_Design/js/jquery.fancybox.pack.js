...
(function(B, x, f, q) {
        ...
        defaults: {
            ...
            tpl: {
                ...
                iframe: '<iframe id="fancybox-frame{rnd}" name="fancybox-frame{rnd}" class="fancybox-iframe" frameborder="0" vspace="0" hspace="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen' +
                    (navigator.userAgent.match(/msie [6]/i) ? ' allowtransparency="true"' : "") + "></iframe>",
    ...
    b.helpers.overlay = {
        ...
        update: function() {
            ...
            navigator.userAgent.match(/msie [6]/i) ? (b = Math.max(x.documentElement.offsetWidth, x.body.offsetWidth), m.width() > b && (a = m.width())) : m.width() > r.width() && (a = m.width());
            ...
            if (p(e) && "" !== f.trim(e)) {
                ...
                switch (c) {
                    ...
                    case "over":
                        ...
                        break;
                    default:
                        c = b.skin, d.appendTo("body"), navigator.userAgent.match(/msie [6]/i) && d.width(d.width()), d.wrapInner('<span class="child"></span>'), b.current.margin[2] += Math.abs(k(d.css("margin-bottom")))
                }
